...
class Sidebar extends PureComponent {
    render () {
        ...
        return <Fragment>
            ...
            <Form>
              <Form.Input label={`Maximum Price : ${maxPrice}$ `} min={0} max={999} name="rangePrice" onChange={e => this.props.onChangeFilterPrice(parseInt(e.target.value, 10))} step={5} type="range" value={maxPrice} />
            </Form>
